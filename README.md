...
![IMG_20241009_142919](https://github.com/user-attachments/assets/4ec3a560-74e8-4285-8c15-c0a408ff7a5e)
...
```json
{
  ...
  "notes-values@@background-image-editor": "url(http://127.0.0.1:8181/(4)Wall.jpg)",
  "notes-values@@inline-title-bold": 600,
  "hide-elements@@num-of-notes": "none",
  "notes-values@@magazine-background": "URL('https://files.catbox.moe/gqnsc2.jpg')",
  "notes-values@@text-note-align": "justify",
  "notes-values@@magazine-opacity": 0.7,
  "hide-elements@@files-bookmarks-search-bar-position": "1",
  "hide-elements@@vault-settings-position": "1",
  "notes-values@@magazine-title-font": "PlayfairDisplay-Regular",
  "others-values@@nav-bar-blur": false,
  "notes-values@@grayscale-dark-mode": true,
  "files-folders@@disable-root-file-lines": true,
  "yaml-values@@pill-style-alias": true,
  "notes-values@@inline-title-align": "center",
  "notes-values@@line-height-note": 26,
  "notes-values@@focus-active-line-opacity": 1,
  "notes-values@@focus-non-active-line-opacity": 0.5,
  "notes-values@@hide-icon-link-embed-notes": "transparent",
  "notes-values@@h1-size": 1.4,
  "notes-values@@h2-size": 1.2,
  "notes-values@@h3-size": 1,
  "notes-values@@h4-size": 0.8,
  "notes-values@@h5-size": 0.7,
  "notes-values@@h6-size": 0.7,
  "notes-values@@embed-font-size": 0.93,
  "files-folders@@icon-file-size": 1.59,
  "notes-values@@quote-font-size": 0.9,
  "notes-values@@padding-default-note-style": 35,
  "notes-values@@padding-note-content": 0,
  "notes-values@@letter-spacing-note": 0,
  "files-folders@@nav-item-size": null,
  "notes-values@@default-font-size": 0.95,
  "notes-values@@inline-title-size": 1.3,
  "notes-values@@code-size": 0.9,
  "notes-values@@code-size-edit-mode": 0.9,
  "notes-values@@inline-code-size-editor": 0.75,
  "notes-values@@inline-code-size-read": 0.8,
  "hide-elements@@scrollbars": "none",
  "hide-elements@@icon-settings": "none",
  "hide-elements@@explorer-bar-position": "absolute",
...
[@Bluemoondragon07](https://github.com/Bluemoondragon07/obsidian-big-and-bold) For their fantastic theme that encouraged me to choose Obsidian as my replacement for Evernote.

@ariehen In this [post](https://forum.obsidian.md/t/properties-view-css-the-fall-collection/66512) for the properties snippet in notes 

[@death_au](https://github.com/deathau)

[AlanG](https://forum.obsidian.md/t/how-to-disable-line-wrapping-in-code-blocks/69900) for the code block snippet
